...
const {addTask, editTask, deleteTask,fetchTasksToCopyForUser, getTasksByUserAndDate , submitTask, fetchTaskStatusForUser, reorderTasks} = require('../controllers/taskController');
...
router.get('/admin/tasks-for-user/:userId',  getTasksByUserAndDate )
router.get('/admin/tasks-to-copy/:userId', fetchTasksToCopyForUser)
router.post("/admin/reorder/:userId", verifyAdmin, reorderTasks);
